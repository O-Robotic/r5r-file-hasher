...
typedef void (__fastcall *SHA1_FUNC_UPDATE_BLOCKS)(unsigned int state[5], const unsigned char *data, size_t numBlocks);
...
typedef struct
{
  ...
  unsigned __int64 __pad_2[2];
  unsigned int state[SHA1_NUM_DIGEST_WORDS];
  unsigned int __pad_3[3];
